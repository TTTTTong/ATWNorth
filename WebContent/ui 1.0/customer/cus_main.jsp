...
<header>
  ...
  <nav>
    <ul>
      <li>
        <a href="goods.jsp" data-title="首页" target="123">首页</a>
      </li>
      <li>
        <a href="shopcar.jsp" data-title="购物车" target="123">购物车</a>
      </li>
      <li>
        <a href="order.jsp" data-title="订单" target="123">订单</a>
      </li>
      <li>
        <a href="person.jsp" data-title="个人" target="123">个人信息</a>
      </li>
      <li>
        <a href="about.jsp" data-title="关于" target="123">关于</a>
      </li>
      <li>
        <a href="javascript:void(0);" data-title="Search" target="123">Search</a>
      </li>
    </ul>
  </nav>
</header>
<main>
  ...
  <!--  <a href="${pageContext.request.contextPath}/LogoutServlet">Hello ${username}!</a> -->
   ...
   <article class="larg">
<div>
    <iframe src="goods.jsp" frameborder="0" width=1100px height=580px name="123" scrolling="auto" frameborder="0" ></iframe>
</div>
  </article>
</main>
